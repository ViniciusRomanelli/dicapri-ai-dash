...
export default function DiCapriTaco() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('/api/crews/dicapri-taco', {
        method: 'POST',
        headers: {
      ...
      setResult('Ocorreu um erro ao processar seu prompt.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto py-8">
      <BackButton />
      <h1 className="text-3xl font-bold mb-6">DiCapri Taco</h1>
      <p className="mb-6 text-gray-600">
        Assistente especializado para suas necessidades.
      </p>
